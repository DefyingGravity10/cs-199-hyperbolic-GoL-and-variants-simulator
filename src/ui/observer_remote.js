...
(function() {
  ...
  exports.FieldObserverWithRemoreRenderer = FieldObserverWithRemoreRenderer = class FieldObserverWithRemoreRenderer extends FieldObserver {
    constructor(tessellation, appendRewrite, minCellSize = 1.0 / 400.0) {
      ...
      this.rendering = true;
      this.cellSetState = 0;
      this.worker.postMessage(["I", [tessellation.group.n, tessellation.group.m, this.cellTransforms]]);
