...
(function() {
  ...
  ({stringifyFieldData, parseFieldData, importField, randomFillFixedNum, exportField, randomStateGenerator} = require("../core/field.js"));

  ({GenericTransitionFunc, BinaryTransitionFunc, DayNightTransitionFunc, parseTransitionFunction} = require("../core/rule.js"));
  ...
  //{FieldObserverWithRemoreRenderer} = require "./observer_remote.js"
    ...
    //Misc utilities
  ({E, getAjax, ButtonGroup, windowWidth, windowHeight, documentWidth, removeClass, addClass, ValidatingInput} = require("./htmlutil.js"));
