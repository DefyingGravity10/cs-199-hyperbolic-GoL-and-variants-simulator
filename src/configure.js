...
(function() {
  //!/usr/bin/env coffee
  var coffee_outputs, coffee_sources, fs, isWin, joinStrings, js_outputs, js_sources, makeCoffeeSource, makeJsSource, makefile, makefile_template, mkdirp, odir, os, output_dirs, path, walkDir;
